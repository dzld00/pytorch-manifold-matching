...
parser.add_argument('--g_model_name', default='', type=str, help='generator model epoch name')
parser.add_argument('--ml_model_name', default='', type=str, help='metric learning model epoch name')
